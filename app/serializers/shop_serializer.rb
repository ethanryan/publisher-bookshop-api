class ShopSerializer < ActiveModel::Serializer
  attributes :id,
            ...
            def books_sold_count
              object.copies
              .select{|eachCopy| eachCopy.book.publisher.id === instance_options[:pub_id].to_i} #getting publisher_id via instance_options from publishers_controller, to select only those books that were published by the publisher...
